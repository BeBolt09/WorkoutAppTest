        ...
        return (
            ...
            >
                <View style={NewSecondScreenStyles.itemContent}>
                    ...
                    <Text style={[NewSecondScreenStyles.itemText, isSelected && NewSecondScreenStyles.selectedItemText]}>{item.name}</Text>
                </View>
            </TouchableOpacity>
        );
    });
            ...
            <View style={isWeb ? GlobalStyles.webContainer : GlobalStyles.mobileContainer}>
                ...
                >
                    ...
                    <View style={NewSecondScreenStyles.body}>
                        <ScrollView contentContainerStyle={NewSecondScreenStyles.scrollView}>
                            <View style={NewSecondScreenStyles.headerContainer}>
                                <Text style={NewSecondScreenStyles.h2}>
                                    ...
                                    We'll suggest exercises based on what you select.
                                </Text>
                            </View>
                        ...
                        <View style={NewSecondScreenStyles.bottomContainer}>
                            <TouchableOpacity style={[NewSecondScreenStyles.button, selectedEquipment.length > 0 ? NewSecondScreenStyles.buttonFocused : NewSecondScreenStyles.buttonDisabled]} onPress={handleNext} disabled={selectedEquipment.length === 0}>
                                <Text style={NewSecondScreenStyles.buttonText}>Find Substitute</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </LinearGradient>
